...
- Reconnects detected legacy libraries to the current iCloud account while reserving the explicit “Reset iCloud sync” flow for confirmed account changes and manual recovery.
