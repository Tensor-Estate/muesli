...
- Waits for QR device confirmation before the first text transfer, keeps setup in a clear “finishing sync” state, and retries one genuine post-link failure before asking the user to try again.
